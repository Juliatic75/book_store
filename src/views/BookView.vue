  ...
  <div class="page book-view">
      ...
      <div class="grid md:grid-cols-3 md:gap-4">
        ...
        <div class="md:col-span-2">
          ...
          <div class="max-md:hidden">
            <Tabs :tabs="tabs">
              <template #desc>
                <p>Когда в тихом городке происходят жестокие преступления, а улики ведут в тупик, единственной надеждой становится человек, чье свидетельство невозможно проверить. </p>

                <p>Он — ночной свидетель. Его мир существует в тёмное время суток, а граница между реальностью и кошмаром стирается. Но чтобы поймать убийцу, следователю придётся погрузиться в эту тьму и довериться тому, кого все считают безумцем.</p>

                <p>Следователь Игорь Стахов, заложник собственного здравомыслия, вынужден идти по следу, который видится только в полубреду. Но каждая призрачная подсказка свидетеля необъяснимо материальна. </p>

                <p>Вскоре Стахов понимает, что убийца знает о своём ночном двойнике. И тьма, которая когда-то хранила секреты, теперь манит их обоих в смертельную ловушку.</p>
              </template>
              <template #chars>
                <table>
                  <tbody>
            ...
            <div class="price-info mt-9 mb-10">
              <div class="flex justify-between mb-5">
                <div class="font-price flex gap-2">
                  <span>1199 ₽</span>
                  <span class="line-through color-text-lighten">1499 ₽</span>
                </div>
    ...
    <div class="reviews mb-6">
      ...
      <div class="grid grid-cols-3 sm:grid-cols-2 md:grid-cols-3 gap-2">
        <ReviewCard author="Дарья Новикова" description="Блестяще! Граница между безумием и гениальностью стирается с каждой главой. Следователь Стахов — герой нашего времени, заложник не системы, а собственного здравомыслия. " :star-count="4" :like-count="10" />
        <ReviewCard author="Дарья Новикова" description="Блестяще! Граница между безумием и гениальностью стирается с каждой главой. Следователь Стахов — герой нашего времени, заложник не системы, а собственного здравомыслия. " :star-count="4" :like-count="10" />
        <ReviewCard author="Дарья Новикова" description="Блестяще! Граница между безумием и гениальностью стирается с каждой главой. Следователь Стахов — герой нашего времени, заложник не системы, а собственного здравомыслия. " :star-count="4" :like-count="10" />
      </div>
    </div>

    <div class="feedback mb-10">
      <FeedbackSection />
    </div>
    ...
    <div class="similar-books mb-4">
      ...
      <div class="grid grid-cols-3 sm:grid-cols-2 md:grid-cols-3 gap-2">
        <BookCard age="16" author="Ольга Быкова" genre="Роман" title="В метре от тебя" price="1299" description="Каждый день она едет в одном поезде с мужчиной своей мечты. Каждый день они стоят в разных концах вагона, разделенные толпой." />
        <BookCard age="16" author="Ольга Быкова" genre="Роман" title="В метре от тебя" price="1299" description="Каждый день она едет в одном поезде с мужчиной своей мечты. Каждый день они стоят в разных концах вагона, разделенные толпой." />
        <BookCard age="16" author="Ольга Быкова" genre="Роман" title="В метре от тебя" price="1299" description="Каждый день она едет в одном поезде с мужчиной своей мечты. Каждый день они стоят в разных концах вагона, разделенные толпой." />
      </div>
    </div>
